...
: linear_x_threshold_(linear_x_threshold),
  angular_z_threshold_(angular_z_threshold)
{
}

bool StopFilter::is_stopped(const Vector3D & linear_velocity, const Vector3D & angular_velocity) const
{
...
FilterResult StopFilter::apply_stop_filter(const Vector3D & linear_velocity, const Vector3D & angular_velocity) const
{
    FilterResult result;
